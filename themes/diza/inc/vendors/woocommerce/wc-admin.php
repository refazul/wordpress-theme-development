...
if( ! function_exists( 'tbay_size_guide_metabox_output' ) ) {
  function tbay_size_guide_metabox_output( $post ) {
    ...
    <p class="add_product_size_guide_images hide-if-no-js">
      <a href="#" data-choose="<?php esc_attr_e( 'Add Images to Product Size Guide', 'diza' ); ?>" data-update="<?php esc_attr_e( 'Add to image', 'diza' ); ?>" data-delete="<?php esc_attr_e( 'Delete image', 'diza' ); ?>" data-text="<?php esc_attr_e( 'Remove product image', 'diza' ); ?>"><?php esc_html_e( 'Add product Size Guide view images', 'diza' ); ?></a>
    </p>
    <?php
    ...
    function tbay_swatch_attribute_template( $post ){
        ...
        ?>
          ...
          <select name="diza_attribute_select" class="diza_attribute_taxonomy">
            <option value="" selected="selected"><?php esc_html_e( 'Global Setting', 'diza' ); ?></option>
