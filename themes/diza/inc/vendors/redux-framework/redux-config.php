...
if (!class_exists('Diza_Redux_Framework_Config')) {
    ...
    class Diza_Redux_Framework_Config
    {
        ...
        public function setSections()
        {
            ...
            $this->sections[] = array(
                'subsection' => true,
                'title' => esc_html__('Search Products', 'diza'),
                'fields' => array(
                    array(
                        'id' => 'search_query_in',
                        'type' => 'button_set',
                        'title' => esc_html__('Search Query', 'diza'),
                        'options' => array(
                            'title' => esc_html__('Only Title', 'diza'), 
                            'all' => esc_html__('All (Title, Content, Sku)', 'diza'), 
                        ),
                        'default' => 'title'
                    ),
                    array(
                        'id' => 'search_sku_ajax',
                        'type' => 'switch',
                        'title' => esc_html__('Show SKU on AJAX results', 'diza'),
            ...
            $this->sections[] = array(
                'icon' => 'zmdi zmdi-grid',
                'title' => esc_html__('TB Add-Ons Elementor', 'diza'),
            );  

            $this->sections[] = array(
                'subsection' => true,
                'title' => esc_html__('General Add-Ons', 'diza'),
                'desc'       => esc_html__( 'Use the Toggle To Activate or Deactivate the TB Add-Ons elements below.', 'diza' ),
                'class' => 'tab-addons',
                'fields' => diza_redux_elementor_to_list_addons( diza_elementor_general_widgets() ),
            );

            $this->sections[] = array(
                'subsection' => true,
                'title' => esc_html__('Header Add-Ons', 'diza'),
                'desc'       => esc_html__( 'Use the Toggle To Activate or Deactivate the TB Add-Ons elements below.', 'diza' ),
                'class' => 'tab-addons',
                'fields' => diza_redux_elementor_to_list_addons( diza_elementor_header_widgets() ),
            );

            $this->sections[] = array(
                'subsection' => true,
                'title' => esc_html__('WooCommerce Add-Ons', 'diza'),
                'desc'       => esc_html__( 'Use the Toggle To Activate or Deactivate the TB Add-Ons elements below.', 'diza' ),
                'class' => 'tab-addons',
                'fields' => diza_redux_elementor_to_list_addons( diza_elementor_woocommerce_widgets() ),
            );
