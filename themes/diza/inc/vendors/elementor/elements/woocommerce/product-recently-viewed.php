...
class Diza_Elementor_Product_Recently_Viewed extends Diza_Elementor_Carousel_Base {
    ...
    public function get_title() {
        return esc_html__( 'Diza Product Recently Viewed', 'diza' );
    }
    ...
    public function render_content_header() {
        ...
        $empty                      =  esc_html__( 'You have no recent viewed item.', 'diza' );
...
$widgets_manager->register(new Diza_Elementor_Product_Recently_Viewed());