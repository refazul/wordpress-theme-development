...
class Diza_Elementor_Custom_Image_List_Tags extends Diza_Elementor_Carousel_Base {
    ...
    public function get_title() {
        return esc_html__( 'Diza Custom Image List Tags', 'diza' );
    }
    ...
    protected function register_design_content_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tag-icon i,
                    {{WRAPPER}} .tag-icon svg' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
    ...
    public function render_item( $item ) {
        ...
        <?php wc_get_template( 'item-tag/tag-custom-'.$layout.'.php', array('tab'=> $tab,  'tag_link' => $tag_link, 'tag_name' => $tag_name ,'tag_count' => $tag_count ,'count_item' => $count_item , 'icon_array'=> $icon_array ) ); ?>
...
$widgets_manager->register(new Diza_Elementor_Custom_Image_List_Tags());