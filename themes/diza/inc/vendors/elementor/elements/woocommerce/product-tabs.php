...
class Diza_Elementor_Product_Tabs extends  Diza_Elementor_Carousel_Base{
    ...
    public function get_title() {
        return esc_html__( 'Diza Product Tabs', 'diza' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'ajax_tabs',
            [
                'label' => esc_html__( 'Ajax Product Tabs', 'diza' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'description' => esc_html__( 'Show/hidden Ajax Product Tabs', 'diza' ), 
            ]
        );
...
$widgets_manager->register(new Diza_Elementor_Product_Tabs());
