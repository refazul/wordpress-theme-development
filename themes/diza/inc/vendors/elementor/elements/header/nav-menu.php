...
class Diza_Elementor_Nav_Menu extends Diza_Elementor_Widget_Base {
    ...
    private function register_section_toggle_menu() {
        ...
        $this->add_control(
            'ajax_toggle',
            [
                'label' => esc_html__( 'Ajax Toggle Menu', 'diza' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'description' => esc_html__( 'Show/hidden Ajax Toggle Menu', 'diza' ), 
                'condition' => [
    ...
    private function register_section_canvas_menu() {
        ...
        $this->add_control(
            'ajax_canvas',
            [
                'label' => esc_html__( 'Ajax canvas Menu', 'diza' ),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'Show/hidden Ajax canvas Menu', 'diza' ), 
                'default' => 'no',
                'condition' => [ 
                    'show_canvas_menu' => 'yes',
                    'layout!' => 'horizontal',
...
$widgets_manager->register(new Diza_Elementor_Nav_Menu());
