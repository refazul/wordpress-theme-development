...
if ( ! defined( 'ABSPATH' ) || function_exists('Diza_Elementor_Custom_Language') ) {
...
class Diza_Elementor_Custom_Language extends Diza_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Diza Language', 'diza');
    }
    ...
    protected function diza_custom_language() {
        do_action('diza_tbay_header_custom_language');
    }
...
$widgets_manager->register(new Diza_Elementor_Custom_Language());
