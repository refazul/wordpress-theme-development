...
class diza_setup_theme {
    ...
    public function add_scripts() {
        ...
        wp_register_script( 'jquery-countdowntimer', DIZA_SCRIPTS . '/jquery.countdowntimer' . $suffix . '.js', array( ), '1.0', true );
    ...
    public function load_admin_login_styles() {
        wp_enqueue_style( 'diza-login-admin', DIZA_STYLES . '/admin/login-admin.css', array(), '1.0.0' );
    }
 
    public function load_admin_styles() {
        wp_enqueue_style( 'material-design-iconic-font', DIZA_STYLES . '/material-design-iconic-font.css', array(), '2.2.0' ); 
        wp_enqueue_style( 'diza-custom-admin', DIZA_STYLES . '/admin/custom-admin.css', array(), '1.0.0' );
