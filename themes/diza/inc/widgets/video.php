...
class Tbay_Widget_Featured_Video extends Tbay_Widget {
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo  esc_attr($this->get_field_id( 'video_link' )); ?>"><?php esc_html_e('Video link:', 'diza' ); ?></label>
            <br>
            ...
            <br>
            <?php esc_html_e('Support video from Youtube and Vimeo link. Ex: https://www.youtube.com/watch?v=sd0grLQ4voU', 'diza' ); ?>
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_name') ); ?>"><?php esc_html_e('Video name:', 'diza' ); ?></label>
            <br>
