...
class Tbay_Widget_Single_Image extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'diza_single_image',
            esc_html__('Diza Single Image', 'diza'),
            array( 'description' => esc_html__( 'Show single image', 'diza' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e( 'Description:', 'diza' ); ?></label>
        ...
        <label for="<?php echo esc_attr($this->get_field_id( 'single_image' )); ?>"><?php esc_html_e( 'Image:', 'diza' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'alt' )); ?>"><?php esc_html_e( 'Alt:', 'diza' ); ?></label>
