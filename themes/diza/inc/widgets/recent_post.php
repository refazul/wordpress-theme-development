...
class Tbay_Widget_Recent_Post extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'diza_recent_post',
            esc_html__('Diza Recent Posts', 'diza'),
            array( 'description' => esc_html__( 'Show list of recent post', 'diza' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'diza' ); ?></label>
