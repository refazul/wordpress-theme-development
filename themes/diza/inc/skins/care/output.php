...
$main_color_skin 	= '.has-after:hover,button.btn-close:hover,.new-input + span:before,.new-input + label:before,.icon-nunbering .elementor-row > div .elementor-widget-wrap > div:nth-child(1) .elementor-widget-container:before,body .singular-shop div.product .tbay-wishlist a:hover,body .singular-shop div.product .tbay-compare a:hover,.product-block div.button-wishlist .yith-wcwl-wishlistexistsbrowse a i,.product-block div.button-wishlist .yith-wcwl-wishlistaddedbrowse a i';  
$main_bg_skin 		= '.has-after:after , .btn-theme,.new-input:checked + span:before,.new-input:checked + label:before';
