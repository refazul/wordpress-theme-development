  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="searchformlable-<?php echo esc_attr($_id); ?>"><?php esc_html_e('Search', 'diza'); ?></h4>
      </div>
      <div class="modal-body">
			<?php diza_tbay_get_page_templates_parts( 'productsearchform', 'full' ); ?>
      </div>
    </div>
  </div>
</div>
