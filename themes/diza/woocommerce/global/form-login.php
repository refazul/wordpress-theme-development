...
<form class="woocommerce-form woocommerce-form-login login u-columns" method="post" <?php echo esc_attr( $formstyle ); ?>>
	...
	<p class="form-row">
		<input type="text" class="input-text" name="username" id="username" placeholder="<?php esc_attr_e('Username or email', 'diza'); ?>" />
	</p>
	<p class="form-row">
		<input class="input-text" type="password" name="password" id="password" placeholder="<?php esc_attr_e('Password', 'diza'); ?>" />
	</p>
	<div class="clear"></div>
	...
	<p class="form-row last">
		...
		<input type="submit" class="button" name="login" value="<?php esc_attr_e( 'Login', 'diza' ); ?>" />
