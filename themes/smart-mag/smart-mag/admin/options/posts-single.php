...
$fields_social = [
	...
	[
		...
		'type'    => 'select',
		'options' => [
			'' => esc_html__('Default / Background Colors', 'bunyad-admin'),
	...
	[
		...
		'style'   => 'inline-sm',
		'css'     => [
			'.post-share-b' => ['props' => ['--service-width' => '%spx']],
		],
		'context' => [['key' => 'single_share_top', 'value' => 1]],
		'group'   => '_g_single_share_top',
	],
	...
	[
		...
		'style'   => 'inline-sm',
		'css'     => [
			'.post-share-b' => ['props' => ['--service-gap' => '%spx']],
		],
		'context' => [['key' => 'single_share_top', 'value' => 1]],
		'group' => '_g_single_share_top',
	],
	...
	[
		...
		'style'   => 'inline-sm',
		'css'     => [
			'.post-share-b .service i' => ['props' => ['font-size' => '%spx']],
		],
		'context' => [['key' => 'single_share_top', 'value' => 1]],
		'group' => '_g_single_share_top',
	],
	...
	[
		...
		'style'   => 'inline-sm',
		'css'     => [
			'.post-share-b' => ['props' => ['--service-b-radius' => '%spx']],
		],
		'context' => [['key' => 'single_share_top', 'value' => 1]],
		'group' => '_g_single_share_top',
	],
	...
	[
		...
		'style'   => 'inline-sm',
		'css'     => [
			'.post-share-b .service .label' => ['props' => ['font-size' => '%spx']],
		],
		'context' => [['key' => 'single_share_top', 'value' => 1]],
		'group' => '_g_single_share_top',
	],
	...
	[
		...
		'style'   => 'inline-sm',
		'css'     => [
			'.post-share-b .service' => ['props' => ['background-color' => '%s']],
		],
		'context' => [['key' => 'single_share_top', 'value' => 1]],
		'group' => '_g_single_share_top',
	],
...
$fields_modern = [
	...
	[
		...
		'css'     => [
			...
			// 	]
			// ]
			'.s-post-modern .post-content-wrap' => ['props' => ['display' => 'grid']],
			'.s-post-modern .entry-content' => [
				'props' => [
					'max-width' => 'calc(%spx + var(--p-spacious-pad)*2)',
					'justify-self' => 'center'
				]
			]
		],
...
$fields_modern_large = [
	...
	[
		...
		'style'   => 'inline-sm',
		'css'     => [
			'.s-post-large .post-content-wrap' => ['props' => ['display' => 'grid']],
