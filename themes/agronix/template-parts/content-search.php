...
?>
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'single-news mb-55 format-search' );?>>
...
<?php
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'single-news mb-55 format-search' );?> data-wow-delay=".3s">
        <?php if ( has_post_thumbnail() ): ?>    
        <div class="news-thumb">
            <a href="<?php the_permalink();?>">
                <?php the_post_thumbnail( 'full', ['class' => 'img-responsive'] );?>
        ...
        <div class="news-detalis-content news-detalis-content-2 <?php if ( 'product' == get_post_type() ) : ?>blog_p_paddless<?php endif; ?>">
