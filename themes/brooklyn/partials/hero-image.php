...
/**
 * The Template for displaying Image Hero
 *
...
if( ut_return_hero_config('ut_hero_rain_effect' , 'off') == 'on' ) {
    ...
    if( unite_mobile_detection()->isTablet() ) {

         $ut_hero_image = ut_collect_option('ut_hero_image_tablet', $ut_hero_image );

    }

    if( unite_mobile_detection()->isMobile() && !unite_mobile_detection()->isTablet() ) {

        $ut_hero_image = ut_collect_option('ut_hero_image_mobile', $ut_hero_image );
                    ...
                    <?php if( $ut_hero_animation_element_group_split ) : ?> <div class="ut-hero-animation-element ut-hero-animation-element-upper"> <?php endif; ?>
                        ...
                        <?php if( !empty( $ut_company_slogan ) ) : ?>
                            ...
                            if( strpos( $ut_company_slogan, "ut_rotate_words") !== FALSE ) {
                                ...
                                $hero_title_classes[] = 'title-with-wordrotator';
