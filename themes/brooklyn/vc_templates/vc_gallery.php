...
if ( 'nivo' === $type ) {
	...
	//wp_enqueue_script( 'flexslider' ); /* provided by theme */
...
foreach ( $images as $i => $image ) {
	...
	switch ( $onclick ) {
		...
		case 'link_image':
			$link_start = '<a data-exthumbimage="' . $large_img_src . '" class="ut-vc-images-lightbox" href="' . $large_img_src . '">';
			$link_end = '</a>';
			break;
...
$output .= '<div id="' . esc_attr( $id  ) . '" class="' . $css_class . '">';
