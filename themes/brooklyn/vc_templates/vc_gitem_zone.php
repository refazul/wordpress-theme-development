...
if ( strlen( $link ) > 0 && 'none' !== $link ) {
    ...
    if ( 'custom' === $link && ! empty( $url ) ) {
		...
		*/
    	...
    	$image_block = '<a data-exthumbimage="{{ post_image_url }}" href="{{ post_image_url }}" title="{{ post_title }}" class="vc_gitem-link prettyphoto vc-zone-link"></a>';
    	...
    	$image_block = '<a data-exthumbimage="{{ post_image_url }}" href="{{ post_image_url }}" title="{{ post_title }}" class="vc_gitem-link vc-zone-link"></a>';
