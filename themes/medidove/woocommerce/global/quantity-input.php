...
if ($max_value && $min_value === $max_value) {
    ...
    $labelledby = !empty($args['product_name']) ? sprintf(esc_html__('%s quantity', 'medidove'), strip_tags($args['product_name'])) : '';
    ?>
    <div class="product-quantity">
        <label for="<?php echo esc_attr($input_id); ?>"><?php esc_html_e('Quantity', 'medidove'); ?></label>
        <div class="cart-plus-minus">
            <input type="text" id="<?php echo esc_attr($input_id); ?>" class="input-text qty text"
                   ...
                   title="<?php echo esc_attr_x('Qty', 'Product quantity input tooltip', 'medidove'); ?>"
