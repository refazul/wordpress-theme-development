		...
		foreach ($home_feed as $key => $value) {
			if ($key == "users" && isset($home_feed["users"]["value"]) && $home_feed["users"]["value"] == "users") {
				echo "<div class='feed-section feed-section-".$key."'>";
					...
					echo "<div class='user-section user-section-".$user_style.($user_style == "small_grid" || $user_style == "grid" || $user_style == "small" || $user_style == "columns"?" row row-warp":"").($user_style != "normal"?" user-not-normal":"")."'>";
				...
				echo "<div class='feed-section feed-section-".$key."'>
					...
					if (!empty($terms) && !is_wp_error($terms)) {
						$term_list = '<div class="row row-warp cats-sections cat_'.$cat_style.'">';
							$tax_col = "col6";
							$slider_number = 2;
							if ($cats_tax == wpqa_question_categories && ($cat_style == "with_icon_1" || $cat_style == "with_icon_2" || $cat_style == "with_icon_3" || $cat_style == "with_icon_4" || $cat_style == "with_cover_1" || $cat_style == "with_cover_2" || $cat_style == "with_cover_3")) {
								$tax_col = "col4";
								$slider_number = 3;
							...
							}else if ($theme_sidebar == "full" && $cats_tax == wpqa_question_categories && ($cat_style == "with_cover_4" || $cat_style == "with_cover_5" || $cat_style == "with_cover_6")) {
								$tax_col = "col4";
								$slider_number = 3;
							}else {
								if ($theme_sidebar == "full") {
				...
				echo "<div class='feed-section feed-section-".$key."'>
					...
					if (!empty($terms) && !is_wp_error($terms)) {
						$term_list = '<div class="row row-warp cats-sections">';
							$tax_col = "col6";
							$slider_number = 2;
							if ($theme_sidebar == "full") {
								$tax_col = "col4";
