<?php if (is_singular("question") || is_singular("asked-question")) {
...
if (is_singular("question") || is_singular("asked-question") || (isset($related_style) && $related_style == "links")) {
	$args_images = array();
}else {
...
if ($related_query->have_posts()) {?>
	<div class="related-post<?php echo (is_singular("question") || is_singular("asked-question") || $related_style == "links"?" related-post-links":"").(is_singular("question") || is_singular("asked-question")?" related-questions":"")?>">
		<div class="post-inner">
			<h3 class="section-title"><?php echo (is_singular("question") || is_singular("asked-question")?esc_html__('Related Questions',"discy"):esc_html__('Related Posts',"discy"))?></h3>
			<?php if (is_singular("question") || is_singular("asked-question") || $related_style == "links") {
				echo '<ul>';
			}else {
				echo '<div class="row row-warp">';
			}
				while ( $related_query->have_posts() ) : $related_query->the_post();
					if ((is_singular("question") || is_singular("asked-question") || $related_style == "links") && $excerpt_related_title > 0) {?>
						<li>
					...
					<?php }
				endwhile;
			if (is_singular("question") || is_singular("asked-question") || $related_style == "links") {
				echo '</ul>';
			}else {
				echo '</div>';
			}?>
