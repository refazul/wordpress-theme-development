<?php $term_list .= '<div class="col '.$tax_col.'">';
	if (($cats_tax == 'question' || $cats_tax == wpqa_question_categories) && ($cat_style == "with_icon" || $cat_style == "icon_color" || $cat_style == "with_icon_1" || $cat_style == "with_icon_2" || $cat_style == "with_icon_3" || $cat_style == "with_icon_4" || $cat_style == "with_cover_1" || $cat_style == "with_cover_2" || $cat_style == "with_cover_3" || $cat_style == "with_cover_4" || $cat_style == "with_cover_5" || $cat_style == "with_cover_6")) {
	$questions = (has_wpqa()?(int)wpqa_count_posts_by_category("question",wpqa_question_categories,$tax_id):0);
		...
		$term_list .= '<div class="cat-sections cat-sections-icon cat-section-'.$cat_style.(isset($cover_link) && $cover_link != ""?" cat-section-cover":"").'"'.(isset($category_color) && $category_color != "" && ($cat_style == "icon_color" || $cat_style == "with_icon_3" || $cat_style == "with_icon_4")?" style='background-color: rgba(".implode(",",discy_hex2rgb($category_color)).",0.1);border-color: rgba(".implode(",",discy_hex2rgb($category_color)).",0.4)'":"").(isset($custom_css)?$custom_css:"").'>';
			...
			<div class="count-cat-question"><span>'.$questions.'</span>'._n("Question","Questions",$questions,"discy").'</div>';
			if ($follow_category == "on") {
				...
				'.(has_wpqa() && ($cat_style == "with_icon_1" || $cat_style == "with_icon_2" || $cat_style == "with_icon_3" || $cat_style == "with_icon_4" || $cat_style == "with_cover_1" || $cat_style == "with_cover_2" || $cat_style == "with_cover_3" || $cat_style == "with_cover_4" || $cat_style == "with_cover_5" || $cat_style == "with_cover_6")?wpqa_follow_cat_button($tax_id,$user_id,'cat',true,'','cat-sections-icon','follow-cat-count'):"");
			}
			if (isset($cover_link) && $cover_link != "") {
				$term_list .= '</div>';
			}
		...
		$term_list .= (($cats_tax == 'question' || $cats_tax == wpqa_question_categories) && $cat_style == "simple_follow" && $follow_category == "on"?"<div class='cat-sections-follow'>":"").'
		...
		if (($cats_tax == 'question' || $cats_tax == wpqa_question_categories) && $cat_style == "simple_follow" && $follow_category == "on") {
			$cats_follwers = (int)(is_array($cat_follow)?count($cat_follow):0);
