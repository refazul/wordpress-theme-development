<form action="<?php echo esc_url(site_url( '/wp-comments-post.php' ))?>" method="post" enctype="multipart/form-data">
	...
	<div>
		<div class="form-input form-textarea form-comment-normal">
			<?php if ($editor_group_post_comments == "on") {
				...
				$comment_contents = '<textarea name="comment" aria-required="true" placeholder="'.apply_filters("discy_filter_textarea_comment_group",esc_html__("Comment","discy")).'"></textarea>';
			}
	...
	<p class="form-submit">
		...
		<input name="submit" type="submit" value="<?php esc_attr_e('Comment','discy')?>" class="button-default button-hide-click">
	</p>
