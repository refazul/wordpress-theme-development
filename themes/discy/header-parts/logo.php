...
<?php }else {?>
	<a href="<?php echo esc_url(home_url('/'));?>" title="<?php echo esc_attr(get_bloginfo('name','display'))?>" class='logo-name logo float_l'><?php echo esc_html(get_bloginfo('name','display'))?></a>
<?php }?>