...
$masonry_style          = discy_options("post_masonry_style");
...
if (isset($blog_h) && $blog_h == "blog_h") {
	...
	$masonry_style           = discy_options("blog_h_masonry_style");
	...
	if ($custom_blog_setting == "on") {
		...
		$masonry_style         = discy_post_meta("masonry_style_b",$post_id_main);
...
$post_columns  = apply_filters("discy_post_columns_loop_settings",$post_columns,(isset($blog_h)?$blog_h:""));
