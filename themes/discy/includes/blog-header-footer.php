<?php do_action("discy_bfore_posts_head");
$blog_h = discy_options("blog_h");
if ($blog_h == "on") {
	...
	if (((is_front_page() || is_home()) && $blog_h_home_pages == "home_page") || $blog_h_home_pages == "all_pages" || ($blog_h_home_pages == "all_posts" && is_singular("post")) || ($blog_h_home_pages == "all_questions" && (is_singular("question") || is_singular("asked-question"))) || ($blog_h_home_pages == "custom_pages" && is_page() && is_array($blog_h_pages) && isset($post->ID) && in_array($post->ID,$blog_h_pages))) {?>
...
unset($blog_h);
do_action("discy_after_posts_head");?>