    ...
    function edubin_customizer_theme_style()
{
        ...
        $tutor_course_fix_title_height = get_theme_mod('tutor_course_fix_title_height', $defaults['tutor_course_fix_title_height']);
...
<?php if (class_exists('LearnPress')): // LeanPress ?>
      ...
      <?php if ($lp_single_page_layout == '1') : // The section visible only for layout 2 ?>
        .course-detail-info {
            display: none;
        }
      <?php endif; //End // The section visible only for layout 2  ?>

      <?php if ($lp_single_page_layout == '2') :  ?>
