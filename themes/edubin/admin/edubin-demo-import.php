...
class EdubinEnvatoApi
{
    ...
    private static $bearer = "uYJt07Y0Wz9Eum0mX3hsUJtTotYhUvey"; //
...
function edubin_check_tvc()
{
    ...
    if (isset($theme_fv_code)) {
        ...
        $o = EdubinEnvatoApi::verifyPurchase($theme_fv_code);
...
function edubin_import_files()
{
    return array(
        ...
        array(
            ...
            'local_import_file'            => trailingslashit(get_template_directory()) . 'admin/demo/lp-green/content.xml',
            'local_import_widget_file'     => trailingslashit(get_template_directory()) . 'admin/demo/lp-green/widget_data.wie',
            'local_import_customizer_file' => trailingslashit(get_template_directory()) . 'admin/demo/lp-green/customizer.dat',
        ...
        array(
            ...
            'local_import_file'            => trailingslashit(get_template_directory()) . 'admin/demo/tutor-green/content.xml',
            'local_import_widget_file'     => trailingslashit(get_template_directory()) . 'admin/demo/tutor-green/widget_data.wie',
            'local_import_customizer_file' => trailingslashit(get_template_directory()) . 'admin/demo/tutor-green/customizer.dat',
        ...
        array(
            ...
            'local_import_file'            => trailingslashit(get_template_directory()) . 'admin/demo/ld-green//content.xml',
            'local_import_widget_file'     => trailingslashit(get_template_directory()) . 'admin/demo/ld-green//widget_data.wie',
            'local_import_customizer_file' => trailingslashit(get_template_directory()) . 'admin/demo/ld-green//customizer.dat',
