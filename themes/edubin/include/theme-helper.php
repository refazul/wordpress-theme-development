...
if (class_exists('Edubin_Shortcode_Social')):
        ...
        if ( $lp_plugin_version_number['Version'] < '8.12.18'):

        function edubin_admin_notice_old_core_plugin() {
            ?>
            <div class="notice notice notice-error is-dismissible">
                <h2 style=" color: #d63638;"><?php _e( "Please update the Edubin Core plugin to get latest theme features.", 'edubin' ); ?> <a href="<?php echo admin_url( 'admin.php?page=edubin-required-plugins&plugin_status=update' ); ?>"><?php _e( 'Update Now', 'edubin' ); ?></a></h2>
