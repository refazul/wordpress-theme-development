...
$post_class         = $img ? 'blog-box-layout7 post-has-image' : 'blog-box-layout7';
$item_content_class = $img ? 'item-content post-has-image' : 'item-content';
$post_has_category  =  RDTheme::$options['blog_cats'] && has_category() ;
...
<div id="post-<?php the_ID(); ?>" <?php post_class( $post_class ) ?> >
  ...
  <div class="<?php echo esc_attr( $item_content_class ); ?>">
    ...
    <div class="action-area">
		<a href="<?php the_permalink() ; ?>" class="btn-fill gradient-accent"><?php esc_html_e( 'READ MORE', 'optimax' );?><i class="fas fa-long-arrow-alt-right"></i></a>
    </div>
  </div>
</div>
