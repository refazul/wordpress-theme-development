...
<div id="respond-<?php comment_ID(); ?>" class="each-comment media">
	<?php if ( get_option( 'show_avatars' ) ): ?>
		<div class="pull-left imgholder">
			<?php if ( 0 != $args['avatar_size'] ) echo get_avatar( $comment, $args['avatar_size'], "", false, ['class' =>'media-object']); ?>
		</div>
	<?php endif; ?>
	...
	<div class="media-body comments-body">
		...
		<div class="comment-meta clearfix">
			<div class="comment-meta-left">
				...
				<div class="comment-time"><?php printf( esc_html__( ' %1$s / %2$s ago', 'optimax'),  $date, $human_time);?></div>
			</div>
		</div>

		<div class="comment-text">
			<?php if ( '0' == $comment->comment_approved ) : ?>
				<p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'optimax' ); ?></p>
			<?php endif; ?>
			<?php comment_text(); ?>
		</div>
