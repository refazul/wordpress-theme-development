...
?>
<div class="single-case-page demo-case case-style-<?php echo esc_attr( RDTheme::$options['case_single_style'] ); ?> ">
	<div class="single-case-slider">
		<?php get_template_part('template-parts/case/partials/case-slider-1'); ?>
	</div>
