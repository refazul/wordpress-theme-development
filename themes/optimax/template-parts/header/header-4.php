  ...
  <div class="header-menu header-menu-desktop-sticky menu-layout1 pd-x-45">
    <div class="<?php echo esc_attr( Helper::header_container_class() ); ?>">
      <div class="d-flex justify-content-between align-items-center min-84">
        ...
        <?php if ( ( RDTheme::$menu_button ) || ( RDTheme::$search_icon ) ) { ?>
          <div class="d-flex justify-content-end header-right-content">
			...
			<?php if ( RDTheme::$menu_button ) { ?>
				<a href="<?php echo esc_url( RDTheme::$options['menu_button_url'] ); ?>" class="btn-fill-4 btn-shadow mg-t-0 gradient-accent letter-specing-0"><?php echo wp_kses( RDTheme::$options['menu_button_text'] , 'alltext_allow' ); ?></a>
			<?php } ?>
          </div>
        <?php } ?>
      </div>
