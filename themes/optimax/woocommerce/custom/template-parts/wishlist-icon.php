...
$title_before = esc_html__( 'Add to Wishlist', 'optimax' );
$title_after  = esc_html__( 'Aleady exists in Wishlist! Click here to view Wishlist', 'optimax' );
...
$html .= '<img class="ajax-loading" alt="spinner" src="'.Helper::get_img( 'spinner.gif' ).'">';

if ( $text ) {
	$html .= '<span>' . esc_html__( 'WishList', 'optimax' ) . '</span>';
}
