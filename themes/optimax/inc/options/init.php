...
Helper::requires( 'options/newsflash.php' );
...
$args = [
  ...
  'menu_title'           => esc_html__( 'Theme Options', 'optimax' ),
  'page_title'           => esc_html__( 'Theme Options', 'optimax' ),
...
Helper::requires( 'options/socials.php' );
...
Helper::requires( 'options/woocommerce.php' );
Helper::requires( 'options/under-construction.php' );
